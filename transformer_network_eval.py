...
Ysim_grouped = Ysim_grouped.reshape(-1, groupsize, numgroups)
Ytrue_grouped = Ytrue_grouped.reshape(-1, groupsize, numgroups)
print("Ysim_grouped shape : ", Ysim_grouped.shape)
print("Ytrue_grouped shape: ", Ytrue_grouped.shape)
Ysim_recon = np.sum(Ysim_grouped, axis=-1)
Ytrue_recon = np.sum(Ytrue_grouped, axis=-1)
